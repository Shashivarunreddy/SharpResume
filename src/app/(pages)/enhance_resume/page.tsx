...
// ------------------ Component ------------------
export default function EnhanceResumeForm() {
      ...
      >
        ...
        {formData.experience.map((exp, i) => (
          <div key={i} className="border border-blue-100 rounded-lg p-4 mb-4">
            ...
            <button type="button" onClick={() => handleRemoveField("experience", i)} className="text-red-500 mt-2 text-sm">
              Remove
            </button>
          </div>
        ))}
        ...
        {formData.projects.map((proj, i) => (
          <div key={i} className="border border-blue-100 rounded-lg p-4 mb-4">
            ...
            <button type="button" onClick={() => handleRemoveField("projects", i)} className="text-red-500 mt-2 text-sm">
              Remove
            </button>
          </div>
        ))}
        ...
        {formData.certifications.map((cert, i) => (
          <div key={i} className="border border-blue-100 rounded-lg p-4 mb-4">
            ...
            <button type="button" onClick={() => handleRemoveField("certifications", i)} className="text-red-500 mt-2 text-sm">
              Remove
            </button>
          </div>
        ))}
        ...
        {formData.education.map((edu, i) => (
          <div key={i} className="border border-blue-100 rounded-lg p-4 mb-4">
            ...
            <button type="button" onClick={() => handleRemoveField("education", i)} className="text-red-500 mt-2 text-sm">
              Remove
            </button>
          </div>
        ))}
        ...
        {output && (
          <div className="mt-8">
            <h3 className="font-bold mb-2">Enhanced Resume JSON:</h3>
